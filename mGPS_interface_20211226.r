      ...
      conditionalPanel(
        ...
        tabsetPanel(
          ...
          tabPanel("HELP",
                   ...
                   p("4. Click the",strong("Start"),"bar and then click the ",strong("Result Plot")," tab"),
                   br(),
      ...
      conditionalPanel(
        ...
        tabsetPanel(
          ...
          tabPanel("HELP",
                   ...
                   p("12. Click the",strong("Start"),"bar and then click the ",strong("Result Plot")," tab"),
      ...
      Shiny. It can build a microbial origin prediction model and predict 
        ...
        by the user and report the prediction result of the sample source. (If user want
          ...
          tabPanel("HELP",
                  ...
                  p("11. Click the",strong("Start"),"bar and then click the ",strong("Result Plot")," tab"),
